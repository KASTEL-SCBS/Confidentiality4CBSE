...
public class ParameterizedDataSetMapEntryImpl extends AbstractDataSetMapEntryImpl implements ParameterizedDataSetMapEntry {
	 ...
	 * @ordered
	 */
	protected SpecificationParameter parameter;
	 ...
	 * @generated
	 */
	public SpecificationParameter getParameter() {
		if (parameter != null && parameter.eIsProxy()) {
			InternalEObject oldParameter = (InternalEObject)parameter;
			parameter = (SpecificationParameter)eResolveProxy(oldParameter);
	 ...
	 * @generated
	 */
	public SpecificationParameter basicGetParameter() {
		return parameter;
	}
	 ...
	 * @generated
	 */
	public void setParameter(SpecificationParameter newParameter) {
		SpecificationParameter oldParameter = parameter;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case DataPackage.PARAMETERIZED_DATA_SET_MAP_ENTRY__PARAMETER:
				setParameter((SpecificationParameter)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case DataPackage.PARAMETERIZED_DATA_SET_MAP_ENTRY__PARAMETER:
				setParameter((SpecificationParameter)null);
				return;
		}
