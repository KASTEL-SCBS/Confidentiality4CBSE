...
public interface DataPackage extends EPackage {
	...
	/**
	 * The meta object id for the '{@link edu.kit.kastel.scbs.confidentiality.data.impl.SpecificationParameterImpl <em>Specification Parameter</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see edu.kit.kastel.scbs.confidentiality.data.impl.SpecificationParameterImpl
	 * @see edu.kit.kastel.scbs.confidentiality.data.impl.DataPackageImpl#getSpecificationParameter()
	 * @generated
	 */
	int SPECIFICATION_PARAMETER = 4;
	 ...
	 * @ordered
	 */
	int SPECIFICATION_PARAMETER__ID = DATA_IDENTIFYING__ID;
	 ...
	 * @ordered
	 */
	int SPECIFICATION_PARAMETER__NAME = DATA_IDENTIFYING_FEATURE_COUNT + 0;

	/**
	 * The feature id for the '<em><b>Defining Service Parameter</b></em>' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int SPECIFICATION_PARAMETER__DEFINING_SERVICE_PARAMETER = DATA_IDENTIFYING_FEATURE_COUNT + 1;

	/**
	 * The number of structural features of the '<em>Specification Parameter</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int SPECIFICATION_PARAMETER_FEATURE_COUNT = DATA_IDENTIFYING_FEATURE_COUNT + 2;

	/**
	 * The number of operations of the '<em>Specification Parameter</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int SPECIFICATION_PARAMETER_OPERATION_COUNT = DATA_IDENTIFYING_OPERATION_COUNT + 0;
	...
	/**
	 * Returns the meta object for class '{@link edu.kit.kastel.scbs.confidentiality.data.SpecificationParameter <em>Specification Parameter</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Specification Parameter</em>'.
	 * @see edu.kit.kastel.scbs.confidentiality.data.SpecificationParameter
	 * @generated
	 */
	EClass getSpecificationParameter();

	/**
	 * Returns the meta object for the attribute '{@link edu.kit.kastel.scbs.confidentiality.data.SpecificationParameter#getDefiningServiceParameter <em>Defining Service Parameter</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Defining Service Parameter</em>'.
	 * @see edu.kit.kastel.scbs.confidentiality.data.SpecificationParameter#getDefiningServiceParameter()
	 * @see #getSpecificationParameter()
	 * @generated
	 */
	EAttribute getSpecificationParameter_DefiningServiceParameter();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '{@link edu.kit.kastel.scbs.confidentiality.data.impl.SpecificationParameterImpl <em>Specification Parameter</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see edu.kit.kastel.scbs.confidentiality.data.impl.SpecificationParameterImpl
		 * @see edu.kit.kastel.scbs.confidentiality.data.impl.DataPackageImpl#getSpecificationParameter()
		 * @generated
		 */
		EClass SPECIFICATION_PARAMETER = eINSTANCE.getSpecificationParameter();

		/**
		 * The meta object literal for the '<em><b>Defining Service Parameter</b></em>' attribute feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EAttribute SPECIFICATION_PARAMETER__DEFINING_SERVICE_PARAMETER = eINSTANCE.getSpecificationParameter_DefiningServiceParameter();
