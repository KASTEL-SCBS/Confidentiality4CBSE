...
public interface RepositoryPackage extends EPackage {
	...
	/**
	 * The meta object id for the '{@link edu.kit.kastel.scbs.confidentiality.repository.impl.AddedServiceParameterImpl <em>Added Service Parameter</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see edu.kit.kastel.scbs.confidentiality.repository.impl.AddedServiceParameterImpl
	 * @see edu.kit.kastel.scbs.confidentiality.repository.impl.RepositoryPackageImpl#getAddedServiceParameter()
	 * @generated
	 */
	int ADDED_SERVICE_PARAMETER = 1;
	 ...
	 * @ordered
	 */
	int ADDED_SERVICE_PARAMETER__ID = ConfidentialityPackage.IDENTIFIED_ELEMENT__ID;
	 ...
	 * @ordered
	 */
	int ADDED_SERVICE_PARAMETER__NAME = ConfidentialityPackage.IDENTIFIED_ELEMENT_FEATURE_COUNT + 0;

	/**
	 * The number of structural features of the '<em>Added Service Parameter</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int ADDED_SERVICE_PARAMETER_FEATURE_COUNT = ConfidentialityPackage.IDENTIFIED_ELEMENT_FEATURE_COUNT + 1;

	/**
	 * The number of operations of the '<em>Added Service Parameter</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int ADDED_SERVICE_PARAMETER_OPERATION_COUNT = ConfidentialityPackage.IDENTIFIED_ELEMENT_OPERATION_COUNT + 0;
	...
	/**
	 * Returns the meta object for class '{@link edu.kit.kastel.scbs.confidentiality.repository.AddedServiceParameter <em>Added Service Parameter</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Added Service Parameter</em>'.
	 * @see edu.kit.kastel.scbs.confidentiality.repository.AddedServiceParameter
	 * @generated
	 */
	EClass getAddedServiceParameter();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '{@link edu.kit.kastel.scbs.confidentiality.repository.impl.AddedServiceParameterImpl <em>Added Service Parameter</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see edu.kit.kastel.scbs.confidentiality.repository.impl.AddedServiceParameterImpl
		 * @see edu.kit.kastel.scbs.confidentiality.repository.impl.RepositoryPackageImpl#getAddedServiceParameter()
		 * @generated
		 */
		EClass ADDED_SERVICE_PARAMETER = eINSTANCE.getAddedServiceParameter();
