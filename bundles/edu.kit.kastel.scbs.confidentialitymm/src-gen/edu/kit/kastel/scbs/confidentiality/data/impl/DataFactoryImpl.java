...
public class DataFactoryImpl extends EFactoryImpl implements DataFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case DataPackage.SPECIFICATION_PARAMETER: return createSpecificationParameter();
	 ...
	 * @generated
	 */
	public SpecificationParameter createSpecificationParameter() {
		SpecificationParameterImpl specificationParameter = new SpecificationParameterImpl();
