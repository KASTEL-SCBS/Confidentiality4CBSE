...
public interface RepositoryFactory extends EFactory {
	...
	/**
	 * Returns a new object of class '<em>Added Service Parameter</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return a new object of class '<em>Added Service Parameter</em>'.
	 * @generated
	 */
	AddedServiceParameter createAddedServiceParameter();
