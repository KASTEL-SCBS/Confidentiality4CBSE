...
public class RepositoryAdapterFactory extends AdapterFactoryImpl {
	...
	protected RepositorySwitch<Adapter> modelSwitch =
		new RepositorySwitch<Adapter>() {
			@Override
			public Adapter caseParametersAndDataPair(ParametersAndDataPair object) {
				return createParametersAndDataPairAdapter();
			}
			@Override
			public Adapter caseAddedServiceParameter(AddedServiceParameter object) {
				return createAddedServiceParameterAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link edu.kit.kastel.scbs.confidentiality.repository.ParametersAndDataPair <em>Parameters And Data Pair</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createParametersAndDataPairAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link edu.kit.kastel.scbs.confidentiality.repository.AddedServiceParameter <em>Added Service Parameter</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
