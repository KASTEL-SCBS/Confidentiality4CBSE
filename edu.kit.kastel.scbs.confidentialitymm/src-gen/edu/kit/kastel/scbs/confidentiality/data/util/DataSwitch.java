...
public class DataSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case DataPackage.SPECIFICATION_PARAMETER: {
				SpecificationParameter specificationParameter = (SpecificationParameter)theEObject;
				T result = caseSpecificationParameter(specificationParameter);
				if (result == null) result = caseDataIdentifying(specificationParameter);
				if (result == null) result = caseNamedElement(specificationParameter);
				if (result == null) result = caseIdentifiedElement(specificationParameter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Specification Parameter</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Specification Parameter</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSpecificationParameter(SpecificationParameter object) {
		return null;
	}
