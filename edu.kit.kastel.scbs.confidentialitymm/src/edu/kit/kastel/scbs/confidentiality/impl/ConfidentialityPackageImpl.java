...
public class ConfidentialityPackageImpl extends EPackageImpl implements ConfidentialityPackage {
	 ...
	 * @generated
	 */
	public EReference getConfidentialitySpecification_AddedFunctionalParameters() {
	 ...
	 * @generated
	 */
	public EReference getConfidentialitySpecification_DataParameterSubstitutions() {
	 ...
	 * @generated
	 */
	public EReference getConfidentialitySpecification_DataParameterUsages() {
	...
	public void createPackageContents() {
		...
		createEReference(confidentialitySpecificationEClass, CONFIDENTIALITY_SPECIFICATION__ADDED_FUNCTIONAL_PARAMETERS);
		createEReference(confidentialitySpecificationEClass, CONFIDENTIALITY_SPECIFICATION__DATA_PARAMETER_SUBSTITUTIONS);
		createEReference(confidentialitySpecificationEClass, CONFIDENTIALITY_SPECIFICATION__DATA_PARAMETER_USAGES);
	...
	public void initializePackageContents() {
		...
		initEReference(getConfidentialitySpecification_AddedFunctionalParameters(), theRepositoryPackage.getAddedFunctionalParameter(), null, "addedFunctionalParameters", null, 0, -1, ConfidentialitySpecification.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getConfidentialitySpecification_DataParameterSubstitutions(), theSystemPackage.getAbstractDataParameterSubstitution(), null, "dataParameterSubstitutions", null, 0, -1, ConfidentialitySpecification.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getConfidentialitySpecification_DataParameterUsages(), theSystemPackage.getDataParameterUsage(), null, "dataParameterUsages", null, 0, -1, ConfidentialitySpecification.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
