...
public class ConfidentialityAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected ConfidentialitySwitch<Adapter> modelSwitch =
		new ConfidentialitySwitch<Adapter>() {
			@Override
			...
			@Override
			public Adapter caseConfidentialitySpecification(ConfidentialitySpecification object) {
				return createConfidentialitySpecificationAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link edu.kit.kastel.scbs.confidentiality.ConfidentialitySpecification <em>Specification</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
