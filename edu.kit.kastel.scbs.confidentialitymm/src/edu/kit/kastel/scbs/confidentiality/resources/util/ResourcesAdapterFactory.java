/**
 */
package edu.kit.kastel.scbs.confidentiality.resources.util;
...
public class ResourcesAdapterFactory extends AdapterFactoryImpl {
	...
	protected ResourcesSwitch<Adapter> modelSwitch =
		new ResourcesSwitch<Adapter>() {
			...
			@Override
			public Adapter caseTamperProtection(TamperProtection object) {
				return createTamperProtectionAdapter();
			}
			@Override
			public Adapter caseLocationsAndTamperProtectionsPair(LocationsAndTamperProtectionsPair object) {
				return createLocationsAndTamperProtectionsPairAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link edu.kit.kastel.scbs.confidentiality.resources.Location <em>Location</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link edu.kit.kastel.scbs.confidentiality.resources.TamperProtection <em>Tamper Protection</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link edu.kit.kastel.scbs.confidentiality.resources.LocationsAndTamperProtectionsPair <em>Locations And Tamper Protections Pair</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createLocationsAndTamperProtectionsPairAdapter() {
		return null;
	}
