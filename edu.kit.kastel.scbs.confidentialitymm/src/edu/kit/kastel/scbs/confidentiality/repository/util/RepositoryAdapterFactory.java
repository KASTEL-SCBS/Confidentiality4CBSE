...
public class RepositoryAdapterFactory extends AdapterFactoryImpl {
	...
	protected RepositorySwitch<Adapter> modelSwitch =
		new RepositorySwitch<Adapter>() {
			...
			@Override
			public Adapter caseAddedFunctionalParameter(AddedFunctionalParameter object) {
				return createAddedFunctionalParameterAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link edu.kit.kastel.scbs.confidentiality.repository.AddedFunctionalParameter <em>Added Functional Parameter</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createAddedFunctionalParameterAdapter() {
		return null;
	}
