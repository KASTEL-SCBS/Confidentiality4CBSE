...
public class RepositoryPackageImpl extends EPackageImpl implements RepositoryPackage {
	 ...
	 * @generated
	 */
	private EClass addedFunctionalParameterEClass = null;
	 ...
	 * @generated
	 */
	public EClass getAddedFunctionalParameter() {
		return addedFunctionalParameterEClass;
	}
	...
	public void createPackageContents() {
		...
		addedFunctionalParameterEClass = createEClass(ADDED_FUNCTIONAL_PARAMETER);
	}
	...
	public void initializePackageContents() {
		...
		addedFunctionalParameterEClass.getESuperTypes().add(theConfidentialityPackage.getIdentifiedElement());
		addedFunctionalParameterEClass.getESuperTypes().add(theConfidentialityPackage.getNamedElement());
		...
		initEClass(addedFunctionalParameterEClass, AddedFunctionalParameter.class, "AddedFunctionalParameter", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
	}
