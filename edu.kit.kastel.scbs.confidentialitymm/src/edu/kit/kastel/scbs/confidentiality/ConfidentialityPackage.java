...
public interface ConfidentialityPackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>Added Functional Parameters</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int CONFIDENTIALITY_SPECIFICATION__ADDED_FUNCTIONAL_PARAMETERS = IDENTIFIED_ELEMENT_FEATURE_COUNT + 4;

	/**
	 * The feature id for the '<em><b>Data Parameter Substitutions</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int CONFIDENTIALITY_SPECIFICATION__DATA_PARAMETER_SUBSTITUTIONS = IDENTIFIED_ELEMENT_FEATURE_COUNT + 5;

	/**
	 * The feature id for the '<em><b>Data Parameter Usages</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int CONFIDENTIALITY_SPECIFICATION__DATA_PARAMETER_USAGES = IDENTIFIED_ELEMENT_FEATURE_COUNT + 6;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link edu.kit.kastel.scbs.confidentiality.ConfidentialitySpecification#getAddedFunctionalParameters <em>Added Functional Parameters</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Added Functional Parameters</em>'.
	 * @see edu.kit.kastel.scbs.confidentiality.ConfidentialitySpecification#getAddedFunctionalParameters()
	 * @see #getConfidentialitySpecification()
	 * @generated
	 */
	EReference getConfidentialitySpecification_AddedFunctionalParameters();

	/**
	 * Returns the meta object for the containment reference list '{@link edu.kit.kastel.scbs.confidentiality.ConfidentialitySpecification#getDataParameterSubstitutions <em>Data Parameter Substitutions</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Data Parameter Substitutions</em>'.
	 * @see edu.kit.kastel.scbs.confidentiality.ConfidentialitySpecification#getDataParameterSubstitutions()
	 * @see #getConfidentialitySpecification()
	 * @generated
	 */
	EReference getConfidentialitySpecification_DataParameterSubstitutions();

	/**
	 * Returns the meta object for the containment reference list '{@link edu.kit.kastel.scbs.confidentiality.ConfidentialitySpecification#getDataParameterUsages <em>Data Parameter Usages</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Data Parameter Usages</em>'.
	 * @see edu.kit.kastel.scbs.confidentiality.ConfidentialitySpecification#getDataParameterUsages()
	 * @see #getConfidentialitySpecification()
	 * @generated
	 */
	EReference getConfidentialitySpecification_DataParameterUsages();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Added Functional Parameters</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference CONFIDENTIALITY_SPECIFICATION__ADDED_FUNCTIONAL_PARAMETERS = eINSTANCE.getConfidentialitySpecification_AddedFunctionalParameters();

		/**
		 * The meta object literal for the '<em><b>Data Parameter Substitutions</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference CONFIDENTIALITY_SPECIFICATION__DATA_PARAMETER_SUBSTITUTIONS = eINSTANCE.getConfidentialitySpecification_DataParameterSubstitutions();

		/**
		 * The meta object literal for the '<em><b>Data Parameter Usages</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference CONFIDENTIALITY_SPECIFICATION__DATA_PARAMETER_USAGES = eINSTANCE.getConfidentialitySpecification_DataParameterUsages();
