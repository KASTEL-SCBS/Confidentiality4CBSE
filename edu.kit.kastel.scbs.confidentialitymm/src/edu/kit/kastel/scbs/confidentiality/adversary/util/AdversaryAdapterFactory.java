 ...
 * @generated
 */
public class AdversaryAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	public AdversaryAdapterFactory() {
	 ...
	 * @generated
	 */
	protected AdversarySwitch<Adapter> modelSwitch =
		new AdversarySwitch<Adapter>() {
			@Override
			public Adapter caseAdversaries(Adversaries object) {
				return createAdversariesAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link edu.kit.kastel.scbs.confidentiality.adversary.Adversaries <em>Adversaries</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link edu.kit.kastel.scbs.confidentiality.adversary.Adversary <em>Adversary</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
