...
public class DataPackageImpl extends EPackageImpl implements DataPackage {
	 ...
	 * @generated
	 */
	public EAttribute getDataParameter_DefiningFunctionalParameter() {
	...
	public void createPackageContents() {
		...
		createEAttribute(dataParameterEClass, DATA_PARAMETER__DEFINING_FUNCTIONAL_PARAMETER);
	...
	public void initializePackageContents() {
		...
		dataParameterEClass.getESuperTypes().add(this.getDataIdentifying());
		dataParameterEClass.getESuperTypes().add(theConfidentialityPackage.getNamedElement());
		...
		initEAttribute(getDataParameter_DefiningFunctionalParameter(), ecorePackage.getEString(), "definingFunctionalParameter", null, 0, 1, DataParameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getParameterizedDataSetMapEntry_Parameter(), this.getDataParameter(), null, "parameter", null, 1, 1, ParameterizedDataSetMapEntry.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}
