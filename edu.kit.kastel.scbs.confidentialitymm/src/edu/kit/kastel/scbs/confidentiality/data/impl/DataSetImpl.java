 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.kastel.scbs.confidentiality.data.impl.DataSetImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataSetImpl extends UnparameterizedDataIdentifyingImpl implements DataSet {
	/**
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (derivedFeatureID) {
				case DataPackage.DATA_SET__NAME: return ConfidentialityPackage.NAMED_ELEMENT__NAME;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (baseFeatureID) {
				case ConfidentialityPackage.NAMED_ELEMENT__NAME: return DataPackage.DATA_SET__NAME;
				default: return -1;
			}
		}
