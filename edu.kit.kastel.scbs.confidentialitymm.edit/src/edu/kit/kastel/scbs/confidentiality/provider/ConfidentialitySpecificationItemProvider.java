...
public class ConfidentialitySpecificationItemProvider extends IdentifiedElementItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ConfidentialityPackage.Literals.CONFIDENTIALITY_SPECIFICATION__ADDED_FUNCTIONAL_PARAMETERS);
			childrenFeatures.add(ConfidentialityPackage.Literals.CONFIDENTIALITY_SPECIFICATION__DATA_PARAMETER_SUBSTITUTIONS);
			childrenFeatures.add(ConfidentialityPackage.Literals.CONFIDENTIALITY_SPECIFICATION__DATA_PARAMETER_USAGES);
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ConfidentialityPackage.Literals.CONFIDENTIALITY_SPECIFICATION__DATA_IDENTIFIER,
				 DataFactory.eINSTANCE.createDataParameter()));
		...
		newChildDescriptors.add
			(createChildParameter
				(ConfidentialityPackage.Literals.CONFIDENTIALITY_SPECIFICATION__ADDED_FUNCTIONAL_PARAMETERS,
				 RepositoryFactory.eINSTANCE.createAddedFunctionalParameter()));

		newChildDescriptors.add
			(createChildParameter
				(ConfidentialityPackage.Literals.CONFIDENTIALITY_SPECIFICATION__DATA_PARAMETER_SUBSTITUTIONS,
				 SystemFactory.eINSTANCE.createDataParameter2DataSetSubstitution()));

		newChildDescriptors.add
			(createChildParameter
				(ConfidentialityPackage.Literals.CONFIDENTIALITY_SPECIFICATION__DATA_PARAMETER_SUBSTITUTIONS,
				 SystemFactory.eINSTANCE.createDataSetMapParameter2KeySubstitution()));

		newChildDescriptors.add
			(createChildParameter
				(ConfidentialityPackage.Literals.CONFIDENTIALITY_SPECIFICATION__DATA_PARAMETER_USAGES,
				 SystemFactory.eINSTANCE.createDataParameterUsage()));
