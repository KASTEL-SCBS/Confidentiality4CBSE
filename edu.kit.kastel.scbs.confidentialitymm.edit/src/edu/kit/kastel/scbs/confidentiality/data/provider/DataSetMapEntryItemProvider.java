...
/**
 * This is the item provider adapter for a {@link edu.kit.kastel.scbs.confidentiality.data.DataSetMapEntry} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataSetMapEntryItemProvider extends AbstractDataSetMapEntryItemProvider {
	...
	public String getText(Object object) {
		String label = getLabel(((DataSetMapEntry)object));
	 ...
	 * @generated NOT
	 */
	private String getLabel(DataSetMapEntry dsme) {
		DataSetMap map = dsme.getMap();
		String mapName = "";
		if (map != null) {
			mapName = map.getName();
		}
		String keyName = dsme.getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DataSetMapEntry.class)) {
